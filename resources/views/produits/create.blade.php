            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="ajout-produit-form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="tempsProduction"
                                            name="tempsProduction" placeholder="Entrer le temps de production(H)">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="fraisTransport"
                                            name="fraisTransport" placeholder="Entrer les frais de transport">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="idCategorie" id="idCategorie">
                                            ...
                                            @foreach ($categories as $categorie)
                                                <option value="{{ $categorie->id }}">{{ $categorie->titreCateg }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
...
@push('scripts')
    <script>
                    ...
                    `<div class="mb-3">
                        <div class="input-group" id="${selectedAcc.id}">
                            ...
                            <div class="input-group-prepend d-flex flex-row">
                                <input type="number" class="form-control input-group-text" name="quantite" placeholder="Entrer la quantité" max="${selectedAcc.qte}">
        ...
        $('#ajout-produit-form').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#message').addClass('alert-success').text(data.message);
                    setTimeout(function() {
                        $('#message').addClass('d-none');
                        $('#message').removeClass('alert-success');

                    }, 3000);
                    $('#ajout-produit-form').trigger('reset');
                },
                error: function(error) {
                    console.log(error);
                    console.log(error.responseJSON.message);
                    $('#message').removeClass('d-none');
                    $('#message').addClass('alert-danger').text(error.responseJSON.message);
                    setTimeout(function() {
                        $('#message').addClass('d-none');
